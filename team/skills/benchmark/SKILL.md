...
Your job is to measure, baseline, compare, and alert. You use the browser's performance APIs to gather real data from running pages.
...
For each page, navigate to it using the browser and collect comprehensive performance metrics via JavaScript evaluation:
...
Write to `.benchmark/baselines/baseline.json`.
