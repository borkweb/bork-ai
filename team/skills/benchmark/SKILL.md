...
description: >
  ...
  baselines for page load times, Core Web Vitals (LCP, CLS, INP), and resource
  sizes. Compares before/after on every PR. Tracks performance trends over
  time. Use when: "performance", "benchmark", "page speed", "web vitals",
